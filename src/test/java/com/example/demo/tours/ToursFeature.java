    ...
    public void getAllTours() {
        try {
            mockMvc.perform(MockMvcRequestBuilders.get("/tour-office/allTours").contentType(MediaType.APPLICATION_JSON)
                    ...
                    .andExpect(status().isOk()) //check Http status code
                    .andExpect(content().json(AllToursJson.json))// copy paste apo postman auto pou perimenoume
